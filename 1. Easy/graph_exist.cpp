...
// vertex is labeled from 0 to n - 1 (inclusive). The edges in
// the graph are represented as a 2D integer array edges, where
// each edges[i] = [ui, vi] denotes a bi-directional edge between
// vertex ui and vertex vi. Every vertex pair is connected by
